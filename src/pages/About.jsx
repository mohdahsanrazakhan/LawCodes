const About = () => {
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 text-gray-800">
      <h1 className="text-3xl font-bold mb-4 text-[#5c47c4] dark:text-[#c6bdff]">About LawCodes.in</h1>
      ...
      <p className="mb-2 text-gray-800 dark:text-gray-200">
        If you have suggestions, spot an error, or just want to say hello — reach out to us at: <a href="mailto:support@lawcodes.in" className="text-[#5c47c4] dark:text-[#afa2ff] underline">support@lawcodes.in</a>
      </p>
    </div>
  );
};
