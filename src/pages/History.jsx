...
const History = () => {
  ...
  return (
    <>
      {/* SEO */}
      <Helmet>
        <title>Search History | Legal Codes</title>
        <meta name="description" content="View your past legal searches. Quickly revisit the legal information you’ve accessed." />
        <link rel="canonical" href="https://www.legalcodes.in/history" />
      </Helmet>
